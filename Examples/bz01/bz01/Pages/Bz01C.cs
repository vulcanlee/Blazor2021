...
{
    [Microsoft.AspNetCore.Components.RouteAttribute("/Bz01C")]
    public partial class Bz01C : Microsoft.AspNetCore.Components.ComponentBase
    {
        /// <summary>
        /// 這裡將會重新產生出最新狀態的轉譯樹
        /// </summary>
        ...
        private void IncrementCount()
        {
            ...
            currentCount++;
            Console.WriteLine($"第 1 次呼叫 StateHasChanged");
            StateHasChanged();
            currentCount++;
            Console.WriteLine($"第 2 次呼叫 StateHasChanged");
            StateHasChanged();
            currentCount++;
            Console.WriteLine($"第 3 次呼叫 StateHasChanged");
            StateHasChanged();
        }
